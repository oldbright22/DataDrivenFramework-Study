...
public class TestBase {
	...
	public WebDriver launchBrowser(String url){
		System.out.println("LOG Launching Browser.");
		...
		try {
			...
			System.out.println("LOG Complete Launching Browser.");

		} catch(Exception Exp)
		{
			System.out.println("LOG Exception Launching Browser."+ Exp.getMessage());
		}
